    ...
    <div className='loginPage d-flex align-items-center my-auto justify-content-center'>
      <div className="login-container">
        <form className="login-form">
          ...
          <input type="email" placeholder="First Name" name="first" className="custominput" />
          <input type="email" placeholder="Last Name" name="last" className="custominput" />
          </div>
          ...
          <input type="password" placeholder="Confirm Password" name="password" className="input" />
